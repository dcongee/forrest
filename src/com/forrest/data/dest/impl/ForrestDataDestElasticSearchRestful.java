...
public class ForrestDataDestElasticSearchRestful extends ForrestDataAbstractDestination
		implements ForrestDataDestination {
	private Logger logger = Logger.getLogger(ForrestDataDestElasticSearchRestful.class);
	...
	public ForrestDataDestElasticSearchRestful(String esHost, int esPort) {
		this.esHost = esHost;
		this.esPort = esPort;
		initElasticSearchConfig();
	}

	public ForrestDataDestElasticSearchRestful(ForrestDataConfig config, ForrestMonitor forrestMonitor) {
		// super();
